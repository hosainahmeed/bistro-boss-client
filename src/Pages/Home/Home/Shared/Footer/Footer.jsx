function Footer() {
  const contactDetails = {
    ...
    mobileNumber: "+88 123456789",
  };
  
  return (
    <footer>
      <div className="footer bg-[#1F2937] flex justify-around md:flex-row flex-col items-center text-neutral-content p-10">
        <div className="footer-center">
          <h1 className="text-3xl">CONTACT US</h1>
          <p className="text-base">
            {contactDetails.Street}
            <br /> {contactDetails.mobileNumber}
            <br />
